<?php include_once 'includes/templates/header.php' ?>
    ...
    <section class="seccion contenedor">
        ...
        <form id="registro" class="registro" action="validar_registro.php" method="post">
            ...
            <!-- Fin Paquetes -->
            <!-- Inicio Código copiado de https://gist.github.com/juanpablogdl/d3c12e82fb6b78b8a7222c2b716fb3ab -->
            <div id="eventos" class="eventos clearfix">
                <h3>Elige tus talleres</h3>
                <div class="caja">
                  <?php
                  // En esta parte del curso se describía la forma de cargar estos datos desde la BBDD en lugar de ser html estático 
                  /*try {
                ...
                mejores lugares para encontrar trabajo</lFabel>
            ...
            <!--#eventos-->
            <!-- Fin código copiado de https://gist.github.com/juanpablogdl/d3c12e82fb6b78b8a7222c2b716fb3ab -->
            <!-- Inicio Pago y Extras -->
